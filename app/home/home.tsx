          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              >
                <Link 
                  href="/home" 
                  className="modern-glass px-6 py-2 rounded-full bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium hover:from-green-500 hover:to-emerald-500 transition-all duration-300 neon-glow-green"
                >
                  Dashboard
                </Link>
                <Link 
            ...
            >
              <div className="px-4 py-6 space-y-4">
                ...
                <div className="pt-4 space-y-3">
                  <Link 
                    href="/home" 
                    className="block w-full text-center bg-gradient-to-r from-green-600 to-emerald-600 text-white px-6 py-3 rounded-full font-medium hover:from-green-500 hover:to-emerald-500 transition-all duration-300"
                  >
                    Dashboard
                  </Link>
                  <Link 
